...
<div class="container">
    <div class="row">
        <div class="col-sm-12 bd-example">
            <form name="theForm" action="queue.php" method="post"
        ...
        ?>
                    ...
                    <tr>
                        <td style="text-align: left; width: 50%"><strong>Enable
                                Queue Manager</strong><br> Enable the
                            Queue Manager to allow users to queue
                            torrents:</td>
                        <td><select name="AllowQueing"
                            class="form-control">
                                <option value="1">true</option>
                                <option value="0"
                                    <?php echo (!$settings->get('AllowQueing')) ? 'selected' : '' ?>>false</option>
                        </select></td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 350"><strong>tfQManager
                                Path</strong><br> Specify the path to
                            the tfQManager python script:</td>
                        <td><input name="tfQManager" type="Text"
                            maxlength="254"
                            value="<?php echo ($settings->get('tfQManager')); ?>"
                            class="form-control"><?php echo validateFile($settings->get('tfQManager'))?>
                    </td>
                    </tr>
    <?php 
/*
    ...
    ?>
                <tr>
                        <td style="text-align: left; width: 350"><strong>Max
                                Server Threads</strong><br> Specify the
                            maximum number of torrents the server will
                            allow to run at one time (admins may
                            override this):</td>
                        <td><input name="maxServerThreads" type="Text"
                            maxlength="3"
                            value="<?php echo $settings->get('maxServerThreads') ?>"
                            class="form-control"></td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 350"><strong>Max
                                User Threads</strong><br> Specify the
                            maximum number of torrents a single user may
                            run at one time:</td>
                        <td><input name="maxUserThreads" type="Text"
                            maxlength="3"
                            value="<?php echo $settings->get('maxUserThreads') ?>"
                            class="form-control"></td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 350"><strong>Polling
                                Interval</strong><br> Number of seconds
                            the Queue Manager will sleep before checking
                            for new torrents to run:</td>
                        <td><input name="sleepInterval" type="Text"
                            maxlength="3"
                            value="<?php echo $settings->get('sleepInterval') ?>"
                            class="form-control"></td>
                    </tr>
                    <tr>
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 bd-example">
            <table class="table table-striped">
                <tr>
                    <th colspan="3"><img src="../images/properties.png"
                        alt="">&nbsp;&nbsp; Queued Items</th>
                </tr>
                <tr>
        ...
        while ($filename = readdir($handle)) {
            if ($filename != "tfQManager.log") {
                if ($filename != "." && $filename != ".." && strpos($filename, ".pid") == 0) {
                    ...
                    $output .= "</div></td>";
                    $output .= "<td><div style=\"text-align:center\"><div class=\"tiny\" style=\"text-align:left\">" . str_replace(array(
                        ".Qinfo",
                        ".stat"
                    ), "", $filename) . "</div></td>";
    ...
    <div class="row">
        <div class="col-sm-12 bd-example">
            <table class="table table-striped">
                <tr>
                    <th colspan="3"><img src="../images/properties.png"
                        alt="">&nbsp;&nbsp; Running Items</th>
                
                
                <tr>
                    <th style="width: 15%"><?php echo _USER?>
                    
                    </td>
                    <th><?php echo _FILE?>
                    
                    </td>
                    <th style="width: 1%"><?php echo str_replace(" ","<br>",_FORCESTOP)?>
