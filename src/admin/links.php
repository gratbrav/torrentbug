    ...
    <div class="row">
        <div class="col-sm-12 bd-example">
            <table class="table table-striped">
                <tr>
                    <th colspan="2"><img src="../images/properties.png"
                        alt="">&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan=2 style="text-align: center">
                        <form action="links.php" method="post">
                            ...
                            Site Name: <input type="text" size="30"
                                maxlength="255" name="newSite"> <input
                                type="Submit"
                                value="<?php echo _UPDATE ?>"><br>
                        </form>
                    </td>
                </tr>
				<?php
                    ...
                    <td colspan="2">
                        <form action="links.php" method="post">
                            <input type="hidden" name="action"
                                ...
                                name="editLink"
                                value="<?php echo $link['url'] ?>"> Site
                            Name: <input type="Text" size="30"
                                maxlength="255" name="editSite"
                                value="<?php echo $link['sitename'] ?>">
                            <input type="hidden" name="lid"
                                value="<?php echo $lid ?>"> <input
                                type="Submit"
                                value="<?php echo _UPDATE ?>"><br>
                        </form>
                    </td>
							...
							<?php } else { ?>
            					<tr>
                    <td><a
                        href="links.php?action=delete&lid=<?php echo $lid ?>"><img
                            src="../images/delete_on.gif" alt=""
                            title="<?php echo _DELETE . " " . $lid ?>"></a>&nbsp;
                        <a
                        href="links.php?action=edits&edit=<?php echo $lid ?>"><img
                            src="../images/properties.png" alt=""
                            title="<?php echo _EDIT . " " . $lid ?>"></a>&nbsp;
                        <a href="<?php echo $link['url'] ?>"
                        target="_blank"><?php echo $link['sitename'] ?></a>
                    </td>
