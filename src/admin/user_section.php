<div class="container">
    <div class="row">
        <div class="col-sm-12 bd-example">
            <table class="table table-striped">
                <tr>
                    <th colspan="6"><img src="../images/user_group.gif"
                        alt="" />&nbsp;
    ...
    foreach ($users as $user) {
        ...
        ?>
					        <table class="table table-striped">
                    <tr>
                        <td style="width: 200"><progress
                                class="progress progress-success"
                                value="<?php echo $user_percent ?>"
                                max="100" style="margin-bottom: 0px"><?php echo $user_percent ?>%</progress>
                        </td>
                        <td style="text-align: right; width: 40"><div
                                class="tiny" style="text-align: right"><?php echo $user_activity ?></div></td>
                        <td style="text-align: right; width: 40"><div
                                class="tiny" style="text-align: right"><?php echo $user_percent ?>%</div></td>
                        <td style="text-align: right"><a
                            href="activity.php?user_id=<?= $user->getUserId() ?>"><img
                                src="../images/properties.png" alt=""
                                title="<?= $user->getUserId() . "'s "._USERSACTIVITY ?>" /></a></td>
                    </tr>
                </table>
