...
<div class="container">
    ...
    while (list ($user_id, $file, $time) = $result->FetchRow()) {
        ...
        ?>
        			<tr>
                        <td><a
                            href="message.php?to_user=<?php echo $user_id; ?>"><i class="fa fa-user" aria-hidden="true" style="color:<?php echo $iconColor; ?>;margin-right:4px;"></i><?php echo $user_id; ?></a>&nbsp;&nbsp;</td>
                        <td><?php echo $file; ?></td>
...
<link rel="stylesheet"
    href="/src/plugins/datatables/datatables/media/css/dataTables.bootstrap4.min.css" />
<script
    src="/src/plugins/datatables/datatables/media/js/jquery.dataTables.min.js"></script>
<script
    src="/src/plugins/datatables/datatables/media/js/dataTables.bootstrap4.min.js"></script>
