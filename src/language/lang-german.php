...
define("_SELECTFILE", "W�hle eine Torrent f�r Upload aus");
...
define("_STORAGE", "Speicherkapazit�t");
...
define("_DONE", "FERTIG");
define("_INCOMPLETE", "UNVOLLST�NDIG");
define("_NEW", "NEU");
...
define("_ABOUTTODELETE", "M�chten Sie l�schen");
...
define("_USERSACTIVITY", "Aktivit�t"); // used for popup to display Activity next to users name
...
define("_CONFIRMPASSWORD", "Best�tige Passwort");
define("_HIDEOFFLINEUSERS", "Verstecke Offline Benutzer auf der Home Page");
define("_UPDATE", "Aktualisierung");
define("_USERIDREQUIRED", "Benutzer ID ben�tigt.");
define("_PASSWORDLENGTH", "Ihr Passwort muss sechs oder mehr Zeichen haben.");
define("_PASSWORDNOTMATCH", "Passw�rter stimmen nicht.");
define("_PLEASECHECKFOLLOWING", "Bitte �berpr�fen Sie folgendes"); // Displays errors after this statement
...
define("_BACKTOPARRENT", "Zur�ck zum �bergeordneten Verzeichnis"); // indicates going back to parrent directory
define("_DOWNLOADDETAILS", "Download Details");
define("_PERCENTDONE", "Prozent fertig");
define("_RETURNTOTORRENTS", "Zur�ck zu den Torrents"); // Link at the bottom of each page
define("_DATE", "Datum");
...
define("_PROFILEUPDATEDFOR", "Profil aktualisiert f�r"); // Profile updated for 'username'
...
define("_RETURNTOMESSAGES", "Zuro�ck zu den Nachrichten");
