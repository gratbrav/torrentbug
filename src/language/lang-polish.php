...
define("_ONLINE", "Dost�pni");
define("_OFFLINE", "Niedost�pni");
define("_STORAGE", "Zaj�te");
...
define("_PAGEWILLREFRESH", "Strona odswie�a si� co");
...
define("_ADMINMESSAGE", "Masz w skrzynce wiadomo�� od administratora");
define("_TORRENTS", "Torrenty");
define("_UPLOADHISTORY", "Historia Przesy�ania");
define("_MYPROFILE", "Edytuj M�j Profil");
define("_ADMINISTRATION", "Administracja");
define("_SENDMESSAGETO", "Wy�lij Wiadomo�� do");
...
define("_DOWNLOADSPEED", "Pr�dko�� �ci�gania");
define("_UPLOADSPEED", "Pr�dko�� przesy�ania");
define("_SHARING", "Udost�pnione");
define("_USER", "U�ytkownik");
define("_DONE", "UKO�CZONY");
define("_INCOMPLETE", "NIEKOMPLETNY");
define("_NEW", "NOWY");
define("_TORRENTDETAILS", "Szczeg�y Torrenta");
define("_STOPDOWNLOAD", "Zatrzymaj Torrenta");
define("_RUNTORRENT", "Uruchom Torrenta");
define("_SEEDTORRENT", "Udost�pnij Torrenta");
define("_DELETE", "Usu�");
define("_ABOUTTODELETE", "Usuwasz plik");
define("_NOTOWNER", "Nie jeste� w�a�cicielem tego Torrenta");
define("_MESSAGETOALL", "Ta wiadomo�� zosta�a wys�ana do WSZYSTKICH");
define("_TRYDIFFERENTUSERID", "B��d: Spr�buj inne ID U�ytkownika.");
define("_HASBEENUSED", "ju� instnieje.");
define("_RETURNTOEDIT", "Powr�t do Edycji");
define("_ADMINUSERACTIVITY", "Administracja - Aktywno�� U�ytkownik�w");
define("_ADMIN_MENU", "admin");
define("_ACTIVITY_MENU", "aktywno��");
...
define("_SHOWMORE", "Poka� wi�cej");
define("_ACTIVITYSEARCH", "Przeszukiwanie Aktywno�ci");
define("_FILE", "Plik");
define("_ACTION", "Akcja");
define("_SEARCH", "Szukaj");
define("_ACTIVITYLOG", "Aktywno�� - Ostatnie");
define("_DAYS", "Dni");
define("_IP", "IP");
define("_TIMESTAMP", "Data i Czas");
define("_USERDETAILS", "Szczeg�y U�ytkownia");
define("_HITS", "Akcje");
define("_UPLOADACTIVITY", "Aktywno�� Przesy�ania");
...
define("_USERSACTIVITY", "Aktywno��"); // used for popup to display Activity next to users name
...
define("_TOTALPAGEVIEWS", "Liczba Od�wie�e� Strony");
define("_THEME", "Temat");
define("_USERTYPE", "Typ U�ytkownika");
define("_NEWPASSWORD", "Nowe Has�o");
define("_CONFIRMPASSWORD", "Powt�rz Has�o");
define("_HIDEOFFLINEUSERS", "Ukryj U�ytkownik�w Niedost�pnych");
define("_UPDATE", "Uaktualnij");
define("_USERIDREQUIRED", "ID U�ytkownika jest wymagane.");
define("_PASSWORDLENGTH", "Has�o musi si� sk�ada� z 6 lub wi�cej znak�w.");
define("_PASSWORDNOTMATCH", "Has�a musz� by� identyczne.");
define("_PLEASECHECKFOLLOWING", "Sprawd� poni�sze b��dy"); // Displays errors after this statement
define("_NEWUSER", "Nowy U�ytkownik");
define("_PASSWORD", "Has�o");
define("_CREATE", "Utw�rz"); // button text to create a new user
...
define("_DOWNLOADDETAILS", "Szczeg�y �ci�gania");
define("_PERCENTDONE", "Uko�czono");
define("_RETURNTOTORRENTS", "Powr�t do Torrent�w"); // Link at the bottom of each page
define("_DATE", "Data");
define("_WROTE", "zapisano"); // Used in a reply to tag what the user had writen
define("_SENDMESSAGETITLE", "Wy�lij Wiadomo��"); // Title of page
define("_TO", "Do");
define("_FROM", "Od");
define("_YOURMESSAGE", "Twoja Wiadomo��");
...
define("_RETURNTOMESSAGES", "Powr�t do Wiadomo�ci");
define("_COMPOSE", "Utw�rz"); // As in 'Compose a message' for button
define("_LANGUAGE", "J�zyk"); // label
