...
define("_DRIVESPACEUSED", "Lo spazio disco � usato!");
...
define("_DOWNLOADSPEED", "Velocit� download");
define("_UPLOADSPEED", "Velocit� upload");
...
define("_MESSAGETOALL", "Questo messaggio � stato spedito a TUTTI GLI UTENTI");
define("_TRYDIFFERENTUSERID", "Errore: Prova un altro User ID.");
define("_HASBEENUSED", "� stato usato.");
define("_RETURNTOEDIT", "Ritorna a Modifica");
define("_ADMINUSERACTIVITY", "Amministrazione - Attivit� utente");
define("_ADMIN_MENU", "admin");
define("_ACTIVITY_MENU", "attivit�");
...
define("_SHOWMORE", "Visualizza di pi�");
define("_ACTIVITYSEARCH", "Ricerca attivit�");
define("_FILE", "File");
define("_ACTION", "Azione");
define("_SEARCH", "Ricerca");
define("_ACTIVITYLOG", "Log Attivit� - Ultimo");
define("_DAYS", "Giorni");
define("_IP", "IP");
define("_TIMESTAMP", "Data");
define("_USERDETAILS", "Dettagli utente");
define("_HITS", "Hits");
define("_UPLOADACTIVITY", "Attivit� upload");
...
define("_USERSACTIVITY", "Attivit�"); // used for popup to display Activity next to users name
...
define("_USERIDREQUIRED", "User ID � obbligatorio.");
define("_PASSWORDLENGTH", "La password deve essere di 6 o pi� caratteri.");
