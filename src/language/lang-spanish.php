 ...
 * /*
 * /* Si quieres contribuir con una traducci�n en tu idioma, env�ale un email
 * /* con el archivo a qrome@yahoo.com. Mant�n por favor el orden original,
 * /* y s�lo un mensaje por l�nea; revisa tambi�n tu traducci�n por lo menos dos veces!
 * /*
 * /* Recuerda que hay que cambiar la frase entre comillas, no la que est� en may�sculas!
 * /*
 * /* Si necesitas usar comillas, (") recuerda a�adir una diagonal al rev�s (\),
 * /* para que se vea as�: Esto es \"texto con comillas\" as�.
 * /* Y, si usas c�digo HTML, rev�salo dos veces.
 * /*
 * /* Traducci�n al espa�ol latinoamericano por Alex Neuman van der Hans
 * /* E-mail: opensource@linux.com.pa
 * /* Si necesitas traductor para tu proyecto Open Source, env�ame un e-mail!
 * /* http://linux.com.pa/ - El Portal de Linux para Panam� y el Mundo
 * /*
 * /* Saludos, besos y abrazos a mi esposa Susan, a quien amo con todo mi coraz�n!
 * /*************************************************************************
 */
...
define("_GETFILE", "Cons�galo");
define("_TORRENTLINKS", "Enlaces Torrent");
define("_ONLINE", "En L�nea");
define("_OFFLINE", "Fuera de L�nea");
define("_STORAGE", "Almacenamiento");
define("_DRIVESPACE", "Espacio Disponible");
define("_SERVERSTATS", "Estad�sticas / Qui�n");
define("_DIRECTORYLIST", "Listado del Directorio");
define("_ALL", "Todos");
define("_PAGEWILLREFRESH", "La p�gina se actualizar� en");
define("_SECONDS", "segundos");
define("_TURNONREFRESH", "ACTIVAR Actualizaci�n Autom�tica");
define("_TURNOFFREFRESH", "DESACTIVAR Actualizaci�n Autom�tica");
define("_WARNING", "ADVERTENCIA");
define("_DRIVESPACEUSED", "de espacio en disco est� siendo usado!");
define("_ADMINMESSAGE", "Tiene un mensaje de un administrador en su buz�n de mensajes.");
...
define("_ABOUTTODELETE", "Est�s a punto de borrar");
...
define("_ADMINUSERACTIVITY", "Administraci�n - Actividades de Usuarios");
...
define("_SHOWMORE", "Ver M�s");
define("_ACTIVITYSEARCH", "B�squeda");
define("_FILE", "Archivo");
define("_ACTION", "Acci�n");
define("_SEARCH", "B�squeda");
define("_ACTIVITYLOG", "Bit�cora de los �ltimos");
define("_DAYS", "d�as");
define("_IP", "IP");
...
define("_LASTVISIT", "�ltima Visita"); // header for when the user last visited the site
...
define("_EDIT", "Editar");
define("_USERADMIN", "Administraci�n de Usuarios"); // title of page for user administration
define("_EDITUSER", "Editar Usuario");
define("_UPLOADPARTICIPATION", "Participaci�n en Subidas");
define("_UPLOADS", "Subidas"); // Number of uploads a user has contributed
define("_PERCENTPARTICIPATION", "% de Participaci�n");
define("_PARTICIPATIONSTATEMENT", "Participaci�n y Subidas basados en los �ltimos"); // ends with 15 Days
define("_TOTALPAGEVIEWS", "Vistas Totales de P�gina");
define("_THEME", "Tema");
...
define("_PASSWORDLENGTH", "Clave debe constar de m�s de 6 caracteres.");
...
define("_ADMINEDITLINKS", "Administraci�n de Enlaces");
...
define("_DATE", "Fecha");
define("_WROTE", "Escribi�"); // Used in a reply to tag what the user had writen
