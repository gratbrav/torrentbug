...
define("_TURNONREFRESH", "L�lita lehe taaslaadimine sisse");
define("_TURNOFFREFRESH", "L�lita lehe taaslaadimine v�lja");
define("_WARNING", "HOIATUS");
define("_DRIVESPACEUSED", "K�vaketas!");
define("_ADMINMESSAGE", "Sulle on administraatorilt kiri postkasits.");
define("_TORRENTS", "Torrentid");
define("_UPLOADHISTORY", "�leslaadimise minevik");
...
define("_RUNTORRENT", "K�ivita torrent");
...
define("_MESSAGETOALL", "See s�num saadeti k�ikidele kasutajatele");
...
define("_DAYS", "p�eva");
define("_IP", "IP");
define("_TIMESTAMP", "Kuup�eva formaat");
define("_USERDETAILS", "Kasutaja seaded");
define("_HITS", "Kordi");
define("_UPLOADACTIVITY", "�leslaadimise aktiivsus");
define("_JOINED", "Liitus"); // header for the date when the user joined (became a member)
define("_LASTVISIT", "Viimati k�lastas"); // header for when the user last visited the site
...
define("_UPLOADPARTICIPATION", "�leslaadimisest osav�tmine");
define("_UPLOADS", "�leslaadimisi"); // Number of uploads a user has contributed
define("_PERCENTPARTICIPATION", "Osav�tmine protsentuaalselt");
define("_PARTICIPATIONSTATEMENT", "Osav�tt ja ulesselaadimised viimased"); // ends with 15 Days
define("_TOTALPAGEVIEWS", "Lehevaatamisi kokku");
define("_THEME", "Teema");
define("_USERTYPE", "Kasutaja t��p");
define("_NEWPASSWORD", "Uus parool");
define("_CONFIRMPASSWORD", "Korda parooli");
define("_HIDEOFFLINEUSERS", "Peida v�ljalogitud kasutajad esilehel");
define("_UPDATE", "Uuenda");
define("_USERIDREQUIRED", "Kasutaja ID on vajalik.");
define("_PASSWORDLENGTH", "Parool peab olema pikem kui 5 t�hem�rki.");
define("_PASSWORDNOTMATCH", "Paroolid ei kattu.");
define("_PLEASECHECKFOLLOWING", "Kontrolli j�rgnevaid"); // Displays errors after this statement
...
define("_FULLURLLINK", "T�ispikk URL");
...
define("_SENDTOALLUSERS", "Saada k�ikidele kasutajatele");
...
define("_MESSAGE", "S�num");
define("_MESSAGES", "S�numid"); // plural (more than one)
...
define("_QUEUELIST", "J�rjekord"); // Queuelist
...
define("_TOTALUL", "Kogu �lesselaadimine"); // Total upload at main page
