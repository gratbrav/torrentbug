 ...
 * /*************************************************************************
 */
define("_SELECTFILE", "Velg en torrent � laste opp");
...
define("_DRIVESPACE", "Disk st�rrelse");
...
define("_FILESIZE", "File st�rrelse");
define("_STATUS", "Status");
define("_ADMIN", "Admin");
define("_BADFILE", "feil p� filen");
...
define("_ABOUTTODELETE", "Du skal til � slette");
...
define("_TRYDIFFERENTUSERID", "Feil: Pr�v en annen bruker ID.");
...
define("_ACTIVITYSEARCH", "S�k aktivitet");
define("_FILE", "Fil");
...
define("_LASTVISIT", "Bes�kte sist"); // header for when the user last visited the site
...
define("_HIDEOFFLINEUSERS", "Skjul brukere som er offline p� hovedsiden");
define("_UPDATE", "Oppdater");
define("_USERIDREQUIRED", "Bruker ID kreves.");
define("_PASSWORDLENGTH", "Passordet m� ha mer enn 6 tegn.");
define("_PASSWORDNOTMATCH", "Passordene stemmer ikke.");
define("_PLEASECHECKFOLLOWING", "Vennligst sjekk f�lgende"); // Displays errors after this statement
...
define("_FORCEUSERSTOREAD", "Tving bruker(e) til � lese"); // Admin option in messaging
