...
<div class="container">
    <div class="row">
        <div class="col-sm-12 bd-example">
            <form
                action="?op=<?php echo ( !empty( $cid ) ) ? "modCookie" : "addCookie"; ?>"
                " method="post">
                ...
                <table class="table table-striped">
                    <tr>
                        <th colspan="3"><img src="images/properties.png"
                            alt=\"\">&nbsp;Cookie Management</th>
                    </tr>
                    <tr>
                        <td width="80" align="right">&nbsp;Host:</td>
                        <td><input type="Text" class="form-control"
                            maxlength="255" name="host"
                            <?php echo $hostvalue;?> /></td>
                        <td>www.host.com</td>
                    </tr>
                    <tr>
                        <td width="80" align="right">&nbsp;Data:</td>
                        <td><input type="Text" class="form-control"
                            maxlength="255" name="data"
                            <?php echo $datavalue;?> /></td>
                        <td>uid=123456;pass=a1b2c3d4e5f6g7h8i9j1</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><input type="Submit"
                            value="<?php echo ( !empty( $cid ) ) ? _UPDATE : "Add"; ?>"
    ...
    if (! empty($cid)) {
                            ...
                            <table class="table table-striped">
                                <tr>
                                    <td
                                        ...
                                        width="50">Action</td>
                                    <td
                                        style="font-weight: bold; padding-left: 3px;">Host</td>
                                    <td
                                        style="font-weight: bold; padding-left: 3px;">Data</td>
                                </tr>
								<?php
        ...
        if (empty($dat)) {
            ?>
			                	<tr>
                                    <td colspan="3">No cookie entries
                                        exist.</td>
                                </tr>
								<?php
        } else {
            ...
            foreach ($dat as $cookie) {
                ?>
					                    <tr>
                                    <td><a
                                        href="?op=deleteCookie&cid=<?php echo $cookie["cid"];?>"><img
                                            src="images/delete_on.gif"
                                            width=16 height=16 border=0
                                            title="<?php echo _DELETE . " " . $cookie["host"]; ?>"
                                            align="absmiddle"></a> <a
                                        href="?op=editCookies&cid=<?php echo $cookie["cid"];?>"><img
                                            src="images/properties.png"
                                            width=18 height=13 border=0
                                            title="<?php echo _EDIT . " " . $cookie["host"]; ?>"
