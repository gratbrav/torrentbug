    ...
    function parseResponse()
    {
        ...
        while (is_integer(strpos($thing, "Results"))) {
            ...
            foreach ($tmpListArr as $key => $value) {
                if (strpos($value, "Similar&nbsp;pages")) {} elseif (strpos($value, "ile Format:")) {} elseif (strpos($value, "Cached")) {} elseif (strpos($value, "More results from")) {} elseif (strpos($value, "Translate this page")) {} else {
