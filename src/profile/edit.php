    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <fieldset class="form-group bd-example"
                style="margin-right: -12px; margin-left: -15px;">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><progress class="progress progress-success"
                                value="<?php echo $user_percent ?>"
                                max="100" style="margin-bottom: 0px"><?php echo $user_percent*2 ?>%</progress></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center"><div
                                style="text-align: center" class="tiny">(<?php echo _PARTICIPATIONSTATEMENT. " " . $settings->get('days_to_keep') . " "._DAYS ?>)</div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center">[ <a
                            href="../profile.php?op=showCookies">Cookie
                                Management</a> ]
                        </td>
                    </tr>
                </table>
        ...
        <div class="col-sm-6">
            <fieldset class="form-group bd-example"
                ...
                <form id="formProfile" name="theForm"
                    action="../profile.php?op=updateProfile"
                    method="post">
                    <table class="table table-striped">
                        <tr>
                            <td style="text-align: right"><?php echo _USER ?>:</td>
                            <td><input disabled type="Text"
                                value="<?php echo $cfg["user"] ?>"
                                class="form-control"></td>
                        </tr>
                        <tr>
                            <td style="text-align: right"><?php echo _NEWPASSWORD ?>:</td>
                            <td><input name="pass1" id="pass1"
                                type="Password" value=""
                                class="form-control"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><input name="hideOffline"
                                type="Checkbox" value="1"
                                <?php echo $hideChecked ?> /> <?php echo _HIDEOFFLINEUSERS ?></td>
                        </tr>
                        <tr>
                            <td style="text-align: center" colspan="2"><input
                                id="submitProfile" type="button"
