...
<body bgcolor="<?php echo $cfg["body_data_bg"]; ?>">
    ...
    <div align="center">
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <form name="theForm" target="_parent" action="index.php"
                    method="POST">
                    <input type="hidden" name="closeme" value="true"> <input
                        type="hidden" name="torrent"
                    ...
                    <td>
                        ...
                        <table width="100%" cellpadding="2"
                            ...
                            <tr>
                                ...
                                <td><input type="Text" name="maxuploads"
                                    maxlength="2" size="2"
                                    value="<?php echo $settings->get('max_uploads') ?>"></td>
                            </tr>
                            <tr>
                                <td align="right" valign="top">Max
                                    Download Rate:</td>
                                <td valign="top"><input type="Text"
                                    name="drate" maxlength="4" size="4"
                                    value="<?php echo $settings->get('max_download_rate') ?>">
                                    kB/s<font class="tiny"> (0 = max)</font></td>
                                <td align="Left" colspan="2"
                                    valign="top"><input type="Checkbox"
                                    name="superseeder" value="1">Super
                                    Seeder<font class="tiny"> (dedicated
                                        seed only)</font></td>
                            </tr>
                            <tr>
                                <td align="right" valign="top">Rerequest
                                    Interval:</td>
                                <td valign="top"><input type="Text"
                                    name="rerequest" maxlength="5"
                                    size="5"
                                    value="<?php echo $settings->get('rerequest_interval') ?>"></td>
                                <td align="Left" colspan="2"
                                    valign="top">
<?php
...
?>
                ...
                <select name="runtime" onchange="CheckShareState()">
                                        <option value="True">Die When
                                            Done</option>
                                        <option value="False"
                                            <?php echo $selected ?>>Keep
                                            Seeding</option>
                                </select>
                                </td>
                                <td align="right">Port Range:</td>
                                <td><input type="Text" name="minport"
                                    maxlength="5" size="5"
                                    value="<?php echo $settings->get('minport') ?>">
                                    - <input type="Text" name="maxport"
                                    maxlength="5" size="5"
                            ...
                            <tr>
                                <td colspan="4" align="center"><div
                                        ID="sharekiller" align="center"
                                        style="visibility: hidden;">
                                        Keep seeding until Sharing is: <input
                                            type="Text" name="sharekill"
                                            maxlength="4" size="4"
                                            value="<?php echo $settings->get('sharekill') ?>">%<font
                                            class="tiny"> (0% will keep
                                            seeding)</font>&nbsp;
                                    </div></td>
                            </tr>
                        </table> <br> &nbsp;&nbsp;&nbsp;Torrent Meta
...
?>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td><input type="button" id="startbtn" name="startbtn"
                    value="<?php echo _RUNTORRENT ?>"
                    onclick="StartTorrent();">&nbsp;&nbsp; <input
